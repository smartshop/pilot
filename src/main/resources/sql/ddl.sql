Use smartshop;
create table Address (id bigint not null auto_increment, addressLine1 varchar(255), addressLine2 varchar(255), city varchar(255), country varchar(255), state varchar(255), zipcode bigint, primary key (id)) ENGINE=InnoDB;
